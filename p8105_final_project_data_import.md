...
cps_summary_leisure_2019 = summary_household_category %>% 
  filter(category == "leisure", year == "2019")

cps_summary_leisure_2020 = summary_household_category %>% 
  filter(category == "leisure", year == "2020")

model_full = lm(category_sum_hour_weight ~ race, data = cps_summary_leisure)

model1 = 
  lm(category_sum_hour_weight ~ race, data = cps_summary_leisure_2019)
...
|:------------------------------|---------:|--------:|
| (Intercept)                   | 49935378 |   0.000 |
| raceWhite                     | -2102844 |   0.241 |
| raceAsian                     | -9708835 |   0.004 |
| raceAmerican Indian           |  6978062 |   0.336 |
| race2+ races                  |  1583297 |   0.775 |
| raceHawaiian/Pacific Islander |  9196566 |   0.497 |
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = category_sum_hour_weight ~ race, data = cps_summary_leisure)
    ## 
    ## Coefficients:
    ##                   (Intercept)                      raceWhite  
    ##                      52800861                       -5109805  
    ##                     raceAsian            raceAmerican Indian  
    ##                     -12573207                       -5804761  
    ##                  race2+ races  raceHawaiian/Pacific Islander  
    ##                      -4509640                        7879010

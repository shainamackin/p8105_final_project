...
The table below details average daily hours spent on categories of activities in 2019 versus 2020, along with the percent change. 
...
We created a number of different plots to help visualize this data. 
...
```{r month_code, echo = FALSE, message = FALSE, warning = FALSE}

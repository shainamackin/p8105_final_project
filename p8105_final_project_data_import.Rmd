...
Plotting 2020 activity trends over time:
```{r}
merged_actsum_cps_resp_2020_leisure = merged_actsum_cps_resp_2020 %>%
  filter(category == "leisure")

#if tudiarydate values are equal, then collapse and sum category_sum_hours
#https://stackoverflow.com/questions/16777972/r-collapse-rows-and-sum-the-values-in-the-column 
#ggplot(aes(tudiarydate, category_sum_hour)) + geom_line() 
```

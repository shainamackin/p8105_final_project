...
Here is a tibble of the dataset that has been tidied.

``` r
tibble(atus_sum_long)
```

    ## # A tibble: 3,293,250 x 26
    ##    TUCASEID TU20FWGT TRYHHCHILD TEAGE TESEX PEEDUCA PTDTRACE PEHSPNON GTMETSTA
    ##       <dbl>    <dbl>      <int> <int> <int>   <int>    <int>    <int>    <int>
    ##  1  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  2  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  3  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  4  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  5  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  6  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  7  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  8  2.02e13 5541150.         -1    85     1      44        2        2        1
    ##  9  2.02e13 5541150.         -1    85     1      44        2        2        1
    ## 10  2.02e13 5541150.         -1    85     1      44        2        2        1
    ## # ... with 3,293,240 more rows, and 17 more variables: TELFS <int>,
    ## #   TEMJOT <int>, TRDPFTPT <int>, TESCHENR <int>, TESCHLVL <int>,
    ## #   TRSPPRES <int>, TESPEMPNOT <int>, TRERNWA <int>, TRCHILDNUM <int>,
    ## #   TRSPFTPT <int>, TEHRUSLT <int>, TUDIARYDAY <int>, TRHOLIDAY <int>,
    ## #   TRTEC <int>, TRTHH <int>, activity_codes <chr>, total minutes <int>

Let’s categorize some of the activities

``` r
atus_sum_categorized = atus_sum_long %>%
  mutate(category = case_when(
    ...
    activity_codes %in% c( "Socializing and communicating with others",
                               ...
                               "Watching baseball", #watching sports added here as leisure (used to be in exercise section)
                               "Watching basketball",

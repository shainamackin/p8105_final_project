...
```{r year_model, message=FALSE, show_col_types = FALSE, warning = FALSE, echo = FALSE}
cps_summary_leisure = 
...
```{r residuals_plots, message = FALSE, warning = FALSE, echo = FALSE}
cps_summary_leisure %>% 
...
```{r crossmv_mc, message = FALSE, warning = FALSE, echo = FALSE}
...
```{r rsme_plot, message = FALSE, warning = FALSE, echo = FALSE}
fitted_df %>%

...
We were curious to see how time spent on activities differed depending on age and sex. The plot below shows how time use varies depending on age. 
...
Again, note that the y axis for the first two columns is in hours, and in minutes for the last two columns. Some activities that females spend more time on include caring duties, household activities, personal care, education, religious and spiritual activities and shopping. Males on the other hand spend more time working and exercising as well as engaging in governmental and civic obligations. The average number of minutes females spend on these activities is close to 0. 
